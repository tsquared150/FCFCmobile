...
document.write(
  ...
  '    <h1><span id="widgetTitle">読み込み中...</span> ' +
  '      <span style="font-size: x-small">(HTML5ウィジェットサンプル)</span></h1>' +
  '  </div>' +
